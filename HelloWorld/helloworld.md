...
So, to start our journey into coding, let's write this program in Kotlin. Le't start with the Atomic Kotlin chapter - aptly named
...
### Action
Now let's go to our IDE and open the Atomic Kotlin course. In the 'Programming Basics' -> Hello, World solve the Exercises 1-5
